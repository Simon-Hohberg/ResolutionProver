...
implements TptpParserOutput 
{
                          ...
                          TptpParserOutput.FofFormula formula) 
  {
    ...
    for (String var : variableList) {
      key = 
      (TptpParserOutput.FofFormula)(new Quantified(quantifier,
                                                           sharedCopyOf(var),
                                                           key));
    };
                  ...
                  Iterable<TptpParserOutput.Term> arguments) 
  {
    ...
    Formula key = 
    new Atomic(sharedCopyOf(predicate),arguments);
    Formula res = _formulaTable.get(key);
    if (res == null) {
      _formulaTable.put(key,key);
  ...
  TptpParserOutput.Source createSourceFromFile(String fileName,
                                               String fileInfo) {
    return 
    new tptp.Source.File(sharedCopyOf(fileName),
  ...
  {
    return 
    new tptp.Source.Creator(sharedCopyOf(creatorName), usefulInfo);
  }
  ...
  {
    return 
    new tptp.InfoItem.InferenceRule(sharedCopyOf(inferenceRule),
  ...
  {
    return new tptp.ParentInfo(source,
                          parentDetails == null 
